...
import { baseurl } from "../apitestdata/default"
import { updatebookingdata } from "../apitestdata/body"
import { updatebookingheaders } from "../apitestdata/headers"

export default async function updatebooking(request: APIRequestContext, resources: string, bookingid: string, token: string) {
